...
<head>
    ...
    <style>
        ...
        .bulto .value { font-size: 26px; font-weight: 900; line-height: 1; color: #0f172a; }
        .middle { display: grid; grid-template-columns: 31% 69%; gap: 10px; align-items: center; flex: 1 1 auto; min-height: 0; }
        .qr { display: flex; align-items: center; justify-content: center; min-height: 100%; padding-top: 0; }
        ...
        .client-name { margin: 0; font-size: 22px; line-height: 1.0; font-weight: 900; letter-spacing: -0.02em; }
        ...
        .small-item.phone { margin-top: 2px; font-size: 11px; font-weight: 800; color: #0f172a; }
        .small-item.phone strong { font-weight: 900; }
        ...
        .doc-item strong { color: #0f172a; font-weight: 800; }
    </style>
</head>
    ...
    <div class="label">
        <div class="top">
            ...
            <div class="bulto">
                ...
                <div class="value">{{ $bultoEtiqueta ?: '1/1' }}</div>
            </div>
        </div>

        <div class="middle">
            <div class="qr">
                {!! \SimpleSoftwareIO\QrCode\Facades\QrCode::size(204)->generate($publicUrl) !!}
            </div>
            <div class="right">
