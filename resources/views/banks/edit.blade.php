...
@section('titulo_header', 'Editar Banco Cliente')
                ...
                <div class="card card-primary card-outline">
                    ...
                    <form action="{{ route('banks.update', $bank->id) }}" method="POST" autocomplete="off"
                            ...
                            <div class="form-group row {{ $errors->has('codigo') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="codigo" name="codigo"
                                        placeholder="Código del banco" value="{{ old('codigo', $bank->codigo) }}">
                            ...
                            <div class="form-group row {{ $errors->has('nombre') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                        placeholder="Nombre del banco" value="{{ old('nombre', $bank->nombre) }}" required>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary hint--top" aria-label="Actualizar el registro">
