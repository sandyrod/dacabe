...
@section('content')
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        @if (@$landing->phone)
          <i class="bi bi-phone d-flex align-items-center"><span>{{$landing->phone}}</span></i>
        @endif
        @if (@$landing->schedule)
        <i class="bi bi-clock d-flex align-items-center ms-4"><span> {{$landing->schedule}}</span></i>
        @endif
      </div>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      @if (! @$landing->main_logo)
        <h1 class="logo me-auto me-lg-0"><a href="#">{{$landing->company_name}}</a></h1>
      @else
        <a href="#" class="logo me-auto me-lg-0"><img src="{{ getUrlImage(@$landing, 'main_logo') }}" alt="" class="img-fluid"></a>
      @endif
      ...
      @if (@$landing->whatsapp)
        <a target="_blank" href="https://api.whatsapp.com/send?phone={{$landing->whatsapp}}" class="book-a-table-btn scrollto d-none d-lg-flex"> Contactar</a>
      @endif
    ...
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          ...
          --}}
          <h1><span>{{$landing->company_name}}</span></h1>
          @if (@$landing->slogan)
            <h2>{{$landing->slogan}}</h2>
          @endif
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <a href="#" class="logo me-auto me-lg-0"><img width="200" src="{{getUrlImage(@$landing, 'footer_logo')}}" alt="" class="img-fluid"></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            ...
            <p>
              ...
              @endif
              @if(@$landing->phone)
                <strong>Teléfono:</strong> {{$landing->phone}}<br>
              @endif
              @if(@$landing->email)
              ...
              <div class="social-links mt-3">
                @if(@$landing->facebook)
                  <a target="_blank" href="https://facebook.com/{{$landing->facebook}}" class="facebook"><i class="bx bxl-facebook"></i></a>
                @endif
                @if(@$landing->instagram)
                  <a target="_blank" href="https://instagam.com/{{$landing->instagram}}" class="instagram"><i class="bx bxl-instagram"></i></a>
                @endif                  
              </div>
    ...
    <div class="container">
      <div class="copyright">
        <strong><span>{{$landing->company_name}} - 2024</span></strong>.
      </div>
