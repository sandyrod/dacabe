        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="heading-text"> Unsubscribe </h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row header-menu">
                <div class="col-md-6 col-sm-6 col-xs-12 header-menu-left">
                    <ul class="list-inline">
                        ...
                        <li><span class="active">unsubscribe</span></li>
                    </ul>
                    <!-- .menu -->
                </div>
                <!-- col-md-6 -->
        ...
        <div class="resource-single">
            <div class="container">
                <div class="welcome-text text-center wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".45s">
                    <h2>Se ha eliminado su suscripción</h2>
                    <p>La suscripción de <b>{{$email or 'contacto'}}</b>, ha sido eliminada satisfactoriamente de nuestros registros.
