...
@section('titulo', config('app.name', 'Laravel')  . ' - Productos')

@section('titulo_header', 'Gestión de Productos')
@section('subtitulo_header', 'Productos')
...
@section('content')
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-3 col-xs-12 col-sm-12">                                 
                                    <a href="{{route('order-inven.create')}}" class="card-title btn btn-primary btn-block hint--top" aria-label="Agregar nuevo registro">
                                        <i class="fa fa-plus-circle"> </i>  Agregar
                                    </a>
                            </div>
                            <div class="col-md-6 col-xs-12 col-sm-12">                                 
                                <div class="input-group d-none">
                                  <input type="text" class="form-control general-discount" id="descuento_global" name="descuento_global" placeholder="% Descuento" value="{{$descuento}}">
                                  <span class="input-group-append">
                                    <button type="button" class="btn btn-info btn-flat btn-save-discount">Aplicar % Dcto.</button>
                                  </span>
                                </div>
                            </div>
    ...
    @include('order_inven.partials.modal_photos')
@endsection
