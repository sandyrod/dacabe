...
<script>
    ...
    jQuery(function($) {
        ...
        $("table#"+table_id).on('click', '.permission', function(){
            set_permission($(this).data('iddata'));
        });
        ...
        let set_permission = (id) => {
            swal({
                title: "Aviso!", text: "¿Desea editar los permisos del usuario?", type: "info", showCancelButton: true, confirmButtonColor: '#1274D9', confirmButtonText: 'Si, editar!', cancelButtonText: "Cancelar", closeOnConfirm: false
            }, function(isConfirm){
                if (isConfirm)
                    $(location).attr('href', URL+'/'+id+'/permissions');
