...
@section('content')
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card border-0 shadow" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px !important;">
                    <div class="card-header bg-transparent border-0 py-2" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#ajustesModal">
                            ...
                            <div class="text-white d-flex align-items-center">
                                <div class="me-3 text-end">
                                    <div class="fw-bold d-flex align-items-center">
                                        <span class="badge bg-white bg-opacity-25 me-2 px-2 py-1" style="font-size: 0.85rem; backdrop-filter: blur(10px);">
                                            <i class="fas fa-balance-scale me-1"></i>
                                            Ajustes: {{ isset($total_ajustes_netos) ? number_format($total_ajustes_netos, 2, ',', '.') : '0.00' }}$
                                        </span>
                                        <span class="badge bg-white bg-opacity-25 me-2 px-2 py-1 ml-2" style="font-size: 0.85rem; backdrop-filter: blur(10px);">
                                            <i class="fas fa-chart-line me-1"></i>
                                            Base: {{ isset($total_pagar) ? number_format(max(0, (float)$total_pagar - (float)($total_ajustes_netos ?? 0)), 2, ',', '.') : '0.00' }}$
                                        </span>
                                        <span class="badge bg-warning bg-opacity-50 px-3 py-2 ml-2" style="font-size: 0.9rem; backdrop-filter: blur(10px); border: 2px solid rgba(255, 193, 7, 0.8); box-shadow: 0 0 15px rgba(255, 193, 7, 0.4); animation: pulse 2s infinite;">
                                            <i class="fas fa-star me-1"></i>
                                            Total: {{ isset($total_pagar) ? number_format($total_pagar, 2, ',', '.') : '0.00' }}$
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <div class="mb-2">
                                            ...
                                            <span class="float-end text-success">{{ isset($total_ajustes_netos) ? number_format($total_ajustes_netos, 2, ',', '.') . ' $' : '0.00 $' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <strong>Base sin Ajustes:</strong>
                                            <span class="float-end text-info">{{ isset($total_pagar) ? number_format(max(0, $total_pagar - ($total_ajustes_netos ?? 0)), 2, ',', '.') . ' $' : '0.00 $' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <strong>Total con Ajustes:</strong> 
                                            <span class="float-end text-primary fw-bold">{{ isset($total_pagar) ? number_format($total_pagar, 2, ',', '.') . ' $' : '0.00 $' }}</span>
                                        </div>
                                        <hr>
                                        <div class="text-center">
                                            <small class="text-muted">
                                                Base ({{ isset($total_pagar) ? number_format($total_pagar, 2, ',', '.') : '0.00' }}$) 
                                                + Ajustes ({{ isset($total_ajustes_netos) ? number_format($total_ajustes_netos, 2, ',', '.') : '0.00' }}$) 
                                                = Total ({{ isset($total_pagar) ? number_format($total_pagar, 2, ',', '.') : '0.00' }}$)
                                            </small>
                                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('vendedores.pagos.storeMultiple') }}"
                            ...
                            @if (session('pago_cliente.tipo_pago') == 'bs' && (($total_iva ?? 0) > 0 || ($saldo_iva_total ?? 0) > 0))
                                <div class="row mb-3">
                                    <div class="col-12">
                                    ...
                                    <div style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border: 2px solid #16a34a; border-radius: 12px; padding: 20px 24px;">
                                        ...
                                        <div style="display: flex; flex-wrap: wrap; gap: 12px;">
                                            <label style="flex: 1; min-width: 160px; cursor: pointer;">
                                                <input type="radio" name="abono_tipo" value="ambos" checked style="position: absolute; opacity: 0; z-index: -1;">
                                                <div class="abono-card" data-value="ambos" style="border: 2px solid #16a34a; border-radius: 10px; padding: 14px 18px; background: white; transition: all 0.2s ease; display: flex; align-items: center; gap: 10px;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style="font-size: 11px; color: #6b7280; font-weight: 600; margin-top: 4px;">
                                                            Monto: Bs. {{ number_format($total_iva ?? 0, 2, ',', '.') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </label>
                                            <label style="flex: 1; min-width: 160px; cursor: pointer;">
                                                <input type="radio" name="abono_tipo" value="solo_base" style="position: absolute; opacity: 0; z-index: -1;">
                                                <div class="abono-card" data-value="solo_base" style="border: 2px solid #d1d5db; border-radius: 10px; padding: 14px 18px; background: white; transition: all 0.2s ease; display: flex; align-items: center; gap: 10px;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style="font-size: 11px; color: #6b7280; font-weight: 600; margin-top: 4px;">
                                                            Monto: Bs. {{ number_format(($total_pagar ?? 0) - ($total_retencion ?? 0), 2, ',', '.') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </label>
                                            <label style="flex: 1; min-width: 160px; cursor: pointer;">
                                                <input type="radio" name="abono_tipo" value="solo_iva" style="position: absolute; opacity: 0; z-index: -1;">
                            ...
                            <div class="iva-responsive" style="background: linear-gradient(135deg, #e0f2fe 0%, #bae6fd 100%); border-radius: 20px; padding: 32px; margin-bottom: 24px; border: 3px solid #0ea5e9; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15); position: relative;">
                                ...
                                <div class="iva-header-responsive" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 32px; flex-wrap: wrap; gap: 16px;">
                                    ...
                                    <div style="display: flex; gap: 20px; background: rgba(255, 255, 255, 0.7); padding: 16px 24px; border-radius: 16px; backdrop-filter: blur(10px); border: 2px solid rgba(255, 255, 255, 0.9);">
                                        ...
                                        <div style="text-align: center; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 12px 20px; border-radius: 12px; box-shadow: 0 4px 20px rgba(16, 185, 129, 0.4);">
                                ...
                                <!-- Opciones de pago -->
                                <div class="iva-grid-responsive" style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                                    <!-- Opción 1: Aplicar Retención -->
                                    <div class="iva-hover iva-selected">
                                        ...
                                        <label for="iva_retencion" style="display: block; cursor: pointer;">
                                    ...
                                    <div class="iva-hover">
                                        ...
                                        <label for="iva_completo" style="display: block; cursor: pointer;">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" id="monto" name="monto" value="{{ $total_pagar ?? 0 }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control @error('monto_bs') is-invalid @enderror"
                                        ...
                                        value="{{ old('monto_bs', number_format($total_pagar ?? 0, 2, '.', '')) }}">
                                    @error('monto_bs')
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function actualizarMontoPendiente() {
            ...
            const totalAPagar = {{ json_encode((float)($total_pagar ?? 0)) }};
        ...
        $(document).ready(function() {
            ...
            function manejarCambioOpcion(opcion) {
                ...
                const montoActual = parseFloat('{{ $total_pagar ?? 0 }}'); // Total que viene de la vista anterior
